...
![img](https://a.perfma.net/img/4377948)
...
![TCP是什么](https://a.perfma.net/img/4377964)TCP是什么
...
![消息边界长度标志](https://a.perfma.net/img/4378017)消息边界长度标志
...
![四层网络协议](https://a.perfma.net/img/4378030)四层网络协议
...
![HTTP调用](https://a.perfma.net/img/4378056)HTTP调用
...
![RPC可以像调用本地方法那样调用远端方法](https://a.perfma.net/img/4379098)RPC可以像调用本地方法那样调用远端方法

基于这个思路，大佬们造出了非常多款式的RPC协议，比如比较有名的`gRPC`，`thrift`。

值得注意的是，虽然大部分RPC协议底层使用TCP，但实际上**它们不一定非得使用TCP，改用UDP或者HTTP，其实也可以做到类似的功能。**

![基于TCP协议的HTTP和RPC协议](https://a.perfma.net/img/4379121)基于TCP协议的HTTP和RPC协议
...
![connection_pool](https://a.perfma.net/img/4379151)connection_pool
...
![序列化和反序列化](https://a.perfma.net/img/4379178)序列化和反序列化
...
![HTTP报文](https://a.perfma.net/img/4379206)HTTP报文
...
![HTTP原理](https://a.perfma.net/img/4379213)HTTP原理

![RPC原理](https://a.perfma.net/img/4379243)RPC原理
