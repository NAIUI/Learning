...
## 7、MySQL 怎么知道 varchar(n) 实际占用数据的大小？

MySQL 的 Compact 行格式中会用「变长字段长度列表」存储变长字段实际占用的数据大小。

## 8、varchar(n) 中 n 最大取值为多少？
...
## 11、说一下MySQL是如何执行一条SQL的？具体步骤有哪些？
...
## 15、SQL中的NOW()和CURRENT_DATE()两个函数有什么区别？
...
## 16、count(*) 和 count(1) 有什么区别？哪个性能最好？
...
## 13、数据库优化中有一个比较常用的手段就是把数据表进行拆分，关于拆分数据表你了解哪些？
...
## 14、数据库高并发是我们经常会遇到的，你有什么好的解决方案吗？
