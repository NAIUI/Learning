...
## 25、MySQL 怎么知道 varchar(n) 实际占用数据的大小？

MySQL 的 Compact 行格式中会用「变长字段长度列表」存储变长字段实际占用的数据大小。



## 26、varchar(n) 中 n 最大取值为多少？
...
## 30、count(*) 和 count(1) 有什么区别？哪个性能最好？
